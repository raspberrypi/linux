...
#define IMX258_REG_HDR_MODE                       0x0220
#define IMX258_REG_MODE_SEL                       0x0100
...
#define IMX258_REG_ANA_GAIN_GLOBAL                0x0204
...
static const struct imx258_reg mode_4208x3120_regs[] = {
	...
	REG16(IMX258_REG_LINE_LENGTH_PCK, 0x14E8 ),
	REG16(IMX258_REG_X_ADD_STA, 0),
	REG16(IMX258_REG_Y_ADD_STA, 0),
	REG16(IMX258_REG_X_ADD_END, 0x106F),
	REG16(IMX258_REG_Y_ADD_END, 0x0C2F),
	...
	REG16(IMX258_REG_DIG_CROP_IMAGE_WIDTH, 0x1070),
	REG16(IMX258_REG_DIG_CROP_IMAGE_HEIGHT, 0x0C30),
	REG8(IMX258_REG_SCALE_MODE_EXT, 0),
	REG16(IMX258_REG_SCALE_M_EXT, 16),
	REG8(IMX258_REG_FORCE_FD_SUM, 0),
	REG16(IMX258_REG_X_OUT_SIZE, 0x1070),
	REG16(IMX258_REG_Y_OUT_SIZE, 0x0C30),
	REG8(IMX258_REG_FRM_LENGTH_CTL, 0),
	REG16(IMX258_REG_ANA_GAIN_GLOBAL, 0),
	{ 0x020E, 0x01 },
	{ 0x020F, 0x00 },
	{ 0x0210, 0x01 },
	{ 0x0211, 0x00 },
...
static const struct imx258_reg mode_2104_1560_regs[] = {
	...
	REG16(IMX258_REG_SCALE_M, 0x0020),
	REG16(IMX258_REG_DIG_CROP_X_OFFSET, 0),
	REG16(IMX258_REG_DIG_CROP_Y_OFFSET, 0),
	REG16(IMX258_REG_DIG_CROP_IMAGE_WIDTH, 0x1070),
	REG16(IMX258_REG_DIG_CROP_IMAGE_HEIGHT, 0x0618),
	REG8(IMX258_REG_SCALE_MODE_EXT, 0),
	REG16(IMX258_REG_SCALE_M_EXT, 0x0010),
	REG8(IMX258_REG_FORCE_FD_SUM, 0),
	REG16(IMX258_REG_X_OUT_SIZE, 0x0838),
	REG16(IMX258_REG_Y_OUT_SIZE, 0x0618),
	REG8(IMX258_REG_FRM_LENGTH_CTL, 0),
	REG16(IMX258_REG_ANA_GAIN_GLOBAL, 0),
	{ 0x020E, 0x01 },
	{ 0x020F, 0x00 },
	...
	{ 0x0214, 0x01 },
	{ 0x0215, 0x00 },
	REG8(IMX258_REG_AF_WINDOW_MODE, 1),
	{ 0x94DC, 0x20 },
	{ 0x94DD, 0x20 },
	{ 0x94DE, 0x20 },
	{ 0x95DC, 0x20 },
...
static const struct imx258_reg mode_1048_780_regs[] = {
	...
	REG8(IMX258_REG_SCALE_MODE, 1),
	REG16(IMX258_REG_SCALE_M, 0x0040),
	REG16(IMX258_REG_DIG_CROP_X_OFFSET, 0),
	REG16(IMX258_REG_DIG_CROP_Y_OFFSET, 0),
	REG16(IMX258_REG_DIG_CROP_IMAGE_WIDTH, 0x1070),
	REG16(IMX258_REG_DIG_CROP_IMAGE_HEIGHT, 0x030C),
	REG8(IMX258_REG_SCALE_MODE_EXT, 0),
	REG16(IMX258_REG_SCALE_M_EXT, 0x0010),
	REG8(IMX258_REG_FORCE_FD_SUM, 0),
	REG16(IMX258_REG_X_OUT_SIZE, 0x0418),
	REG16(IMX258_REG_Y_OUT_SIZE, 0x030C),
	REG8(IMX258_REG_FRM_LENGTH_CTL, 0),
	REG16(IMX258_REG_ANA_GAIN_GLOBAL, 0),
	{ 0x020E, 0x01 },
	{ 0x020F, 0x00 },
