...
static int bcm2835_register_node(struct unicam_device *unicam, struct unicam_node *node,
...
static int unicam_async_complete(struct v4l2_async_notifier *notifier)
{
	...
	ret = bcm2835_register_node(unicam, &unicam->node[IMAGE_PAD],
	...
	if (source_pads >= 2) {
		...
		ret = bcm2835_register_node(unicam, &unicam->node[METADATA_PAD],
