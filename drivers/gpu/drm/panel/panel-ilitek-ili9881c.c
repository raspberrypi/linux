...
static const struct ili9881c_instr IE0009504_init[] = {
	ILI9881C_SWITCH_PAGE_INSTR(3),
	...
	ILI9881C_COMMAND_INSTR(0xA0,0x0F),        //VP255Gamma P
	ILI9881C_COMMAND_INSTR(0xA1,0x17),               //VP251
	ILI9881C_COMMAND_INSTR(0xA2,0x22),               //VP247
	ILI9881C_COMMAND_INSTR(0xA3,0x19),              //VP243
	ILI9881C_COMMAND_INSTR(0xA4,0x15),               //VP239
	ILI9881C_COMMAND_INSTR(0xA5,0x28),               //VP231
	ILI9881C_COMMAND_INSTR(0xA6,0x1C),               //VP219
	ILI9881C_COMMAND_INSTR(0xA7,0x1C),               //VP203
	ILI9881C_COMMAND_INSTR(0xA8,0x78),               //VP175
	ILI9881C_COMMAND_INSTR(0xA9,0x1C),               //VP144
	ILI9881C_COMMAND_INSTR(0xAA,0x28),               //VP111
	ILI9881C_COMMAND_INSTR(0xAB,0x69),               //VP80
	ILI9881C_COMMAND_INSTR(0xAC,0x1A),               //VP52
	ILI9881C_COMMAND_INSTR(0xAD,0x19),               //VP36
	ILI9881C_COMMAND_INSTR(0xAE,0x4B),               //VP24
	ILI9881C_COMMAND_INSTR(0xAF,0x22),               //VP16
	ILI9881C_COMMAND_INSTR(0xB0,0x2A),               //VP12
	ILI9881C_COMMAND_INSTR(0xB1,0x4B),               //VP8
	ILI9881C_COMMAND_INSTR(0xB2,0x6B),               //VP4
	ILI9881C_COMMAND_INSTR(0xB3,0x3F),               //VP0

	ILI9881C_COMMAND_INSTR(0xC0,0x01),         //VN255 GAMMA N
	ILI9881C_COMMAND_INSTR(0xC1,0x17),               //VN251
	ILI9881C_COMMAND_INSTR(0xC2,0x22),               //VN247
	ILI9881C_COMMAND_INSTR(0xC3,0x19),              //VN243
	ILI9881C_COMMAND_INSTR(0xC4,0x15),               //VN239
	ILI9881C_COMMAND_INSTR(0xC5,0x28),               //VN231
	ILI9881C_COMMAND_INSTR(0xC6,0x1C),               //VN219
	ILI9881C_COMMAND_INSTR(0xC7,0x1D),               //VN203
	ILI9881C_COMMAND_INSTR(0xC8,0x78),               //VN175
	ILI9881C_COMMAND_INSTR(0xC9,0x1C),               //VN144
	ILI9881C_COMMAND_INSTR(0xCA,0x28),               //VN111
	ILI9881C_COMMAND_INSTR(0xCB,0x69),               //VN80
	ILI9881C_COMMAND_INSTR(0xCC,0x1A),               //VN52
	ILI9881C_COMMAND_INSTR(0xCD,0x19),               //VN36
	ILI9881C_COMMAND_INSTR(0xCE,0x4B),               //VN24
	ILI9881C_COMMAND_INSTR(0xCF,0x22),               //VN16
	ILI9881C_COMMAND_INSTR(0xD0,0x2A),               //VN12
	ILI9881C_COMMAND_INSTR(0xD1,0x4B),               //VN8
	ILI9881C_COMMAND_INSTR(0xD2,0x6B),               //VN4
	ILI9881C_COMMAND_INSTR(0xD3,0x3F),               //VN0

	ILI9881C_SWITCH_PAGE_INSTR(0),
	ILI9881C_COMMAND_INSTR(0x35,0x00),               //TE OUT
	ILI9881C_COMMAND_INSTR(0x35,0x00),
...
static const struct drm_display_mode IE0009504_default_mode = {
	.clock          = 71750,
...
static const struct ili9881c_desc IE0009504_desc = {
	.init = IE0009504_init,
	.init_length = ARRAY_SIZE(IE0009504_init),
	.mode = &IE0009504_default_mode,
	.mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_BURST |
		      MIPI_DSI_MODE_LPM | MIPI_DSI_MODE_NO_EOT_PACKET,
	.lanes = 4,
};
...
static const struct of_device_id ili9881c_of_match[] = {
	...
	{ .compatible = "interelcom,IE0009504", &IE0009504_desc },
	{ }
};
