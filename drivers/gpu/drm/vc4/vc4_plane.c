				 ...
				 uint32_t possible_crtcs)
{
	...
	static const uint64_t modifiers[] = {
		...
		DRM_FORMAT_MOD_BROADCOM_SAND32_COL_HEIGHT(208),
		DRM_FORMAT_MOD_BROADCOM_SAND32_COL_HEIGHT(400),
		DRM_FORMAT_MOD_BROADCOM_SAND32_COL_HEIGHT(624),
		DRM_FORMAT_MOD_BROADCOM_SAND32_COL_HEIGHT(752),
		DRM_FORMAT_MOD_BROADCOM_SAND32_COL_HEIGHT(880),
		DRM_FORMAT_MOD_BROADCOM_SAND32_COL_HEIGHT(1136),
		DRM_FORMAT_MOD_BROADCOM_SAND32_COL_HEIGHT(1648),
		DRM_FORMAT_MOD_BROADCOM_SAND32_COL_HEIGHT(2192),
		DRM_FORMAT_MOD_BROADCOM_SAND32_COL_HEIGHT(3280),
