...
static int clk_hifiberry_dacpro_determine_rate(struct clk_hw *hw,
	struct clk_rate_request *req)
{
	req->rate = clk_hifiberry_dacpro_round_rate(hw, req->rate,
...
const struct clk_ops clk_hifiberry_dacpro_rate_ops = {
	...
	.determine_rate = clk_hifiberry_dacpro_determine_rate,
