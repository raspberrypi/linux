...
static int snd_fe_pi_audio_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	snd_soc_dapm_force_enable_pin(snd_soc_card_to_dapm(card), "LO");
	snd_soc_dapm_force_enable_pin(snd_soc_card_to_dapm(card), "ADC");
	snd_soc_dapm_force_enable_pin(snd_soc_card_to_dapm(card), "DAC");
	snd_soc_dapm_force_enable_pin(snd_soc_card_to_dapm(card), "HP");
