/*
 * ASoC Driver for Google Voice Hat SoundCard
 *
...
{
	.name		= "Google Voice Hat SoundCard",
	.stream_name	= "Google Voice Hat SoundCard HiFi",
...
MODULE_DESCRIPTION("ASoC Driver for Google Voice Hat SoundCard");
